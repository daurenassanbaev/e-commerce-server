...
import com.ecommerce.userservice.exception.RoleAssignmentException;
import com.ecommerce.userservice.exception.RoleNotFoundException;
...
public class KeycloakRoleProvider {
    ...
    public KeycloakRoleResponseDto getRole(UserRole userRole) {
        ...
        if (roleResponseDto == null || roleResponseDto.getId() == null) {
            throw new UserRegistrationException("Role \"" + roleName + "\" not found in Keycloak");
        }
